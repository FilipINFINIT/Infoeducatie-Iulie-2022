...
<html>
    ...
    <script>
        ...
        //modifica aici
        var progresMaxim=50;
        var titlu="Chestionar II";
        var numarIntrebari=4;
        var procentMinim=75;
        var Intrebare = [
            "Ce a ordonat generalul american Douglas MacArthur?",
            "Din cati soldati era formata prima echipa de asalt?",
            "Pentru ce era renumit liderul sud-coreean Syngman Rhee?",
            "Ce perimetru au ocupat trupele comuniste?",
        ];
        var Raspunsuri= [
        ["Retragerea trupelor","O riscanta ofensiva pe mare in orasul port Inchon","Armistitiu","Reintregirea trupelor"],
        ["400 de soldati americani","250 de soldati Coreeni","100 de soldati americani","200 de soldati rusi"],
        ["Pentru bunatate","Pentru cruzime","Pentru tactica sa militara","Pentru coruptie"],
        ["Perimetrul Pusan","Perimetrul Coreea de Sud","Perimetrul Correa de Nord","Perimetrul maritim"],
        ["Raspunsul numarul 1","Raspunsul numarul 2","Raspunsul numarul 3","Raspunsul numarul 4"]
        ];
    ...
    <div class="content-container">
        ...
        <button type="button" style="position:relative;display:none;top:-15px;font-size:2em;" id="buttonpa" onclick='location.href="cap2-1.php"' class="btn btn-danger">Reia Capitolul</button>
        <br>
    </div>
