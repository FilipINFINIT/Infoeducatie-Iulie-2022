...
<head>
    ...
    <script>
        ...
        //modifica aici
        var progresMaxim=25;
        var titlu="Chestionar I";
        var numarIntrebari=5;
        var procentMinim=75;
        var Intrebare = [
            "În ce an a început războiul ?",
            " Unde au avansat mii de luptători comuniști înarmați cu mitraliere PPSh sovietice, artilerie și tancuri T-34-85 ?",
            "Ce voturi pnetru rezoluție a Consiliului de Securitate al ONU au fost ?",
            "Ce parte ocupau trupele americane ?",
            "În ce an s-a terminat războiul ?",
        ];
        var Raspunsuri= [
        ["1949","1952","1950","1951"],
        ["Sud","Est","Nord","Vest"],
        ["Șapte voturi pentru și unul împotrivă","Patru voturi pentru și trei împotrivă","Trei voturi pentru și patru împotrivă","Șase voturi pentru și două împotrivă"],
        ["Nord","Sud","Nord-Est","Sud-Est"],
        ["1951","1954","1952","1953"]
        ];
    ...
    <div class="content-container">
        ...
        <button type="button" style="position:relative;display:none;top:-15px;font-size:2em;" id="buttonpa" onclick='location.href="info.php"' class="btn btn-danger">Reia Capitolul</button>
        <br>
    </div>
