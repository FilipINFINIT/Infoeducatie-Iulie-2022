...
<html>
    ...
    <script>
        ...
        var punctaj=0;
        //modifica aici
        var progresMaxim=100;
        var titlu="Chestionar IV";
        var numarIntrebari=4;
        var procentMinim=75;
        var Intrebare = [
            "In ce an s-a terminat razboiul din Coreea?",
            "Ce acord a semnat comandamentul ONU?",
            "Cati decedati au rezultat in urma acestui razboi?",
            "Cati soldati americani au decedat in urma razboiului?",
        ];
        var Raspunsuri= [
        ["1959","1951","1969","1834"],
        ["Destramarea Coreei de Sud","Armistitiu","Incheierea razboiului dintre cele doua state","Impartirea Coreei de-alungul paralelei 38"],
        ["100.000","25.000","1.230","3.000.000"],
        ["33.686","25.343","10.349","53.222"],
    ...
    <div class="content-container">
        ...
        <button type="button" style="position:relative;display:none;top:-15px;font-size:2em;" id="buttonpa" onclick='location.href="cap4-1.php"' class="btn btn-danger">Reia Capitolul</button>
        <br>
    </div>
